...
class CollaboratorsControllerTest < ActionController::TestCase
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post :create, collaborator: { email: @collaborator.email, image: @collaborator.image, name: @collaborator.name, title: @collaborator.title }
    end
  ...
  test "should update collaborator" do
    patch :update, id: @collaborator, collaborator: { email: @collaborator.email, image: @collaborator.image, name: @collaborator.name, title: @collaborator.title }
    assert_redirected_to collaborator_path(assigns(:collaborator))
  end
